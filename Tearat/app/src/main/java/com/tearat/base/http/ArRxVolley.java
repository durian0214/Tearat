...
public class ArRxVolley {
    ...
    public static void jsonPost(String url, HttpParams params, HttpCallback callback) {
        LogUtil.i(url,params.getJsonParams());
    ...
    public static class Builder {
         ...
         * Http请求参数
         */
        public ArRxVolley.Builder params(HttpParams params) {
            if (Constant.isLogin) {
         ...
         */
        public ArRxVolley.Builder contentType(int contentType) {
         ...
         * 请求回调,不需要可以为空
         */
        public ArRxVolley.Builder callback(HttpCallback callback) {
         ...
         * HttpRequest
         */
        public ArRxVolley.Builder setRequest(Request<?> request) {
         ...
         * HttpRequest的配置器
         */
        public ArRxVolley.Builder httpConfig(RequestConfig httpConfig) {
         ...
         */
        public ArRxVolley.Builder timeout(int timeout) {
         ...
         */
        public ArRxVolley.Builder progressListener(ProgressListener listener) {
         ...
         */
        public ArRxVolley.Builder delayTime(int delayTime) {
         ...
         * 缓存有效时间,单位分钟
         */
        public ArRxVolley.Builder cacheTime(int cacheTime) {
         ...
         */
        public ArRxVolley.Builder useServerControl(boolean useServerControl) {
         ...
         */
        public ArRxVolley.Builder httpMethod(int httpMethod) {
         ...
         * 是否启用缓存
         */
        public ArRxVolley.Builder shouldCache(boolean shouldCache) {
         ...
         * 网络请求接口url
         */
        public ArRxVolley.Builder url(String url) {
         ...
         * 重连策略,不传则使用默认重连策略
         */
        public ArRxVolley.Builder retryPolicy(RetryPolicy retryPolicy) {
         ...
         * 编码,默认UTF-8
         */
        public ArRxVolley.Builder encoding(String encoding) {
            this.httpConfig.mEncoding = encoding;
            return this;
        }

        private ArRxVolley.Builder build() {
            if (request == null) {
                if (params == null) {
